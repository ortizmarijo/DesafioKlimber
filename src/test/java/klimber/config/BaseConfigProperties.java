...
public class BaseConfigProperties {
  ...
  private String mainSiteUrlBase;
  ...
  public void initConfig() {
    ...
    mainSiteUrlBase = prop.getProperty("mainSiteUrlBase");
  }
  ...
  public String getMainSiteUrlBase() {
    return mainSiteUrlBase;
  }
